...
#' Heterogeneous Autoregressive (HAR) model with daily, weekly and monthly lags. The simulations are obtained using the HARSimulate function from the package
#' HARModel.
#'
